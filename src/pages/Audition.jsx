      ...
      <motion.section className="mb-20">
          ...
          {auditionInfo.dates.map((location, index) => (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300">
                  <strong>⏱️ Time:</strong> {location.time}
                </p>
                <p className="text-gray-300">
        ...
        >
          <p className="text-hover-color text-center">
            <strong>NB:</strong> If you missed the registration period, no
            worries—there will be a chance to register at the audition venue.
          </p>
        </motion.div>
      </motion.section>
